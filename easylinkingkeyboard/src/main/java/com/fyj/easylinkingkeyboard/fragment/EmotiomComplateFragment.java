 ...
 * 描述:
 */
public class EmotiomComplateFragment extends EmotionBaseFragment {
    ...
    private void initEmotion() {
        ...
        emotionPagerGvAdapter = new EmotionAndFunctionPagerAdapter(emotionViews);
    ...
    private GridView createEmotionGridView(List<String> emotionNames, int gvWidth, int padding, int itemWidth, int gvHeight) {
        ...
        //设置全局点击事件
        gv.setOnItemClickListener(EmotionGlobalOnItemClickManagerUtils.getInstance().getOnItemClickListener(emotion_map_type));
        return gv;
    }
