 ...
 * 加载更多布局
 */
public class RefreshMorePtrFooter extends RelativeLayout {
    ...
    public RefreshMorePtrFooter(Context context) {
        this(context, null);
    }

    public RefreshMorePtrFooter(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RefreshMorePtrFooter(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public RefreshMorePtrFooter(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
