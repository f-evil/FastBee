 ...
 * 描述:
 */
public class CircleRefreshAndLoadMoreLayout extends PtrFrameLayout implements PtrHandler {
    private static final String TAG = "ReFreshAndLoadMoreLayout";

    //=============================================================元素定义
    private ListView mListView;
    private RefreshMorePtrHeader mHeader;
    ...
    public CircleRefreshAndLoadMoreLayout(Context context) {
        this(context, null);
    }

    public CircleRefreshAndLoadMoreLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleRefreshAndLoadMoreLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView(Context context) {
        //header
        mHeader = new RefreshMorePtrHeader(context);
        //listview
