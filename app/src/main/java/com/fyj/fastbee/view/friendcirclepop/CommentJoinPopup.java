 ...
 * 朋友圈点赞
 */
public class CommentJoinPopup extends BasePopupWindow implements View.OnClickListener {
    private static final String TAG = "CommentPopup";

    private ImageView mLikeView;
    private TextView mLikeText;
    private ImageView mJoinView;
    private TextView mJoinText;

    private RelativeLayout mLikeClikcLayout;
    private RelativeLayout mJoinClickLayout;
    ...
    public CommentJoinPopup(Activity context) {
        ...
        mJoinView = (ImageView) mPopupView.findViewById(R.id.iv_join);
        mJoinText = (TextView) mPopupView.findViewById(R.id.tv_join);

        mLikeClikcLayout = (RelativeLayout) mPopupView.findViewById(R.id.item_like);
        mJoinClickLayout = (RelativeLayout) mPopupView.findViewById(R.id.item_join);
        mCommentClickLayout = (RelativeLayout) mPopupView.findViewById(R.id.item_comment);

        mLikeClikcLayout.setOnClickListener(this);
        mJoinClickLayout.setOnClickListener(this);
    ...
    public View getPopupView() {
        return getPopupViewById(R.layout.popup_join_comment);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.item_join:
                if (mOnCommentPopupClickListener != null) {
                    mOnCommentPopupClickListener.onJoinClick(v, info);
                    mJoinView.clearAnimation();
                    mJoinView.startAnimation(mScaleAnimation);
                }
                break;
    ...
    public void setDynamicInfo(ActivitysBean bean) {
        ...
        if (bean.getIsApplyOrJoin().equals("1")) {
            if ("Post".equalsIgnoreCase(bean.getType()) || "Free".equalsIgnoreCase(bean.getType())){
                mJoinText.setText("退出");
            }else {
                mJoinText.setText("已参加  ");
            }
        } else {
            mJoinText.setText("参加  ");
        }
    }
    ...
    public interface OnCommentPopupClickListener {
        ...
        void onJoinClick(View v, ActivitysBean bean);
