...
#下面中括号的地方需要要填你的包名
-keep public class com.fyj.fastbee.R$*{
...
-keep class com.fyj.fastbee.ui.activity.webview.jsmethod.** {*;}

#---------------------------------自定义View的类------------------------
#在这下面写自定义View的类的类，没有就去掉这句话！
-keep class com.fyj.easylinkingview.** {*;}
