...
public class FileUtils {
     ...
     */
    public boolean isFileExists(String address, String fileName){
     ...
     * @return 返回一个File 对象
     */
    public File createFile(String address, String fileName){
     ...
     */
    public void copyFile(String oldPath, String newPath, boolean deleteOldFile) throws Exception {
        ...
        this.copyFile(new File(oldPath),new File(newPath),deleteOldFile);
    }
     ...
     */
    public synchronized void copyFile(File oldFile, File newFile , boolean deleteOldFile) throws IOException {
        int byteSum = 0;
        int byteRead;
